...
- Clone the forked repository to your local development machine
  (e.g. `git clone git@github.com:<YOUR_GITHUB_USER>/vast_world.git`).
...
Go to the [pull request page of VastWorld][PRs] and in the top
...
[GitHub issue]: https://github.com/signmotion/vast_world/issues/new
[GitHub issues]: https://github.com/signmotion/vast_world/issues/new
[PRs]: https://github.com/signmotion/vast_world/pulls
