...
const ServerStateBase$json = {
  ...
  '3': [ServerStateBase_ClaimedSessionsDevicesEntry$json, ServerStateBase_ApprovedSessionsEntry$json],
};
...
final $typed_data.Uint8List serverStateBaseDescriptor = $convert.base64Decode(
    ...
    'ZXJ2ZXJTdGF0ZUJhc2UuQXBwcm92ZWRTZXNzaW9uc0VudHJ5UhBhcHByb3ZlZFNlc3Npb25zGk'
    'kKG0NsYWltZWRTZXNzaW9uc0RldmljZXNFbnRyeRIQCgNrZXkYASABKAlSA2tleRIUCgV2YWx1'
    'ZRgCIAEoCVIFdmFsdWU6AjgBGkMKFUFwcHJvdmVkU2Vzc2lvbnNFbnRyeRIQCgNrZXkYASABKA'
    'lSA2tleRIUCgV2YWx1ZRgCIAEoCFIFdmFsdWU6AjgB');
