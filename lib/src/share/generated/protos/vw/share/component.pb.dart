...
//  source: vw/share/component.proto
//
// @dart = 2.12
...
class ComponentBase extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ComponentBase', package: const $pb.PackageName(_omitMessageNames ? '' : 'vw.share'), createEmptyInstance: create)
