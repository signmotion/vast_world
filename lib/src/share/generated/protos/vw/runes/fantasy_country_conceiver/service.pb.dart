...
class ConceivingNameAndIdJourneyResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConceivingNameAndIdJourneyResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'vw.runes.fantasy_country_conceiver'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'planHid')
    ..aOS(2, _omitFieldNames ? '' : 'planUid')
    ..aOS(12, _omitFieldNames ? '' : 'title')
    ..aOS(13, _omitFieldNames ? '' : 'synopsis')
    ..aOM<$3.ServerAnswer>(100, _omitFieldNames ? '' : 'answer', subBuilder: $3.ServerAnswer.create)
  ...
  @$pb.TagNumber(100)
  $3.ServerAnswer get answer => $_getN(4);
  @$pb.TagNumber(100)
  set answer($3.ServerAnswer v) { setField(100, v); }
  @$pb.TagNumber(100)
  $core.bool hasAnswer() => $_has(4);
  @$pb.TagNumber(100)
  void clearAnswer() => clearField(100);
  @$pb.TagNumber(100)
  $3.ServerAnswer ensureAnswer() => $_ensure(4);
}

class ConceivingNameAndIdPlaceResponse extends $pb.GeneratedMessage {
  factory ConceivingNameAndIdPlaceResponse({
    $core.String? planHid,
    $core.String? planUid,
    $core.String? title,
  ...
  ConceivingNameAndIdPlaceResponse._() : super();
  factory ConceivingNameAndIdPlaceResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ConceivingNameAndIdPlaceResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ConceivingNameAndIdPlaceResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'vw.runes.fantasy_country_conceiver'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'planHid')
    ..aOS(2, _omitFieldNames ? '' : 'planUid')
    ..aOS(12, _omitFieldNames ? '' : 'title')
    ..aOS(13, _omitFieldNames ? '' : 'description')
    ..m<$core.String, $core.String>(20, _omitFieldNames ? '' : 'predominantColors', entryClassName: 'ConceivingNameAndIdPlaceResponse.PredominantColorsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('vw.runes.fantasy_country_conceiver'))
    ..aOM<$3.ServerAnswer>(100, _omitFieldNames ? '' : 'answer', subBuilder: $3.ServerAnswer.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ConceivingNameAndIdPlaceResponse clone() => ConceivingNameAndIdPlaceResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConceivingNameAndIdPlaceResponse copyWith(void Function(ConceivingNameAndIdPlaceResponse) updates) => super.copyWith((message) => updates(message as ConceivingNameAndIdPlaceResponse)) as ConceivingNameAndIdPlaceResponse;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ConceivingNameAndIdPlaceResponse create() => ConceivingNameAndIdPlaceResponse._();
  ConceivingNameAndIdPlaceResponse createEmptyInstance() => create();
  static $pb.PbList<ConceivingNameAndIdPlaceResponse> createRepeated() => $pb.PbList<ConceivingNameAndIdPlaceResponse>();
  @$core.pragma('dart2js:noInline')
  static ConceivingNameAndIdPlaceResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ConceivingNameAndIdPlaceResponse>(create);
  static ConceivingNameAndIdPlaceResponse? _defaultInstance;
  ...
  @$pb.TagNumber(100)
  $3.ServerAnswer get answer => $_getN(5);
  @$pb.TagNumber(100)
  set answer($3.ServerAnswer v) { setField(100, v); }
  @$pb.TagNumber(100)
  ...
  void clearAnswer() => clearField(100);
  @$pb.TagNumber(100)
  $3.ServerAnswer ensureAnswer() => $_ensure(5);
}
